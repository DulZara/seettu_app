...
import 'screens/seettu_detail_screen.dart';
...
final _router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: '/seettu/:id',
      builder: (context, state) {
        // We expect that whoever navigates here passed a SeettuDetailArgs
        final args = state.extra as SeettuDetailArgs;
        return SeettuDetailScreen(args: args);
      },
    ),
  ],
);
    ...
    return MaterialApp.router(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF1C3B3A), // your green tone
        ),
      ),
    );
  }
